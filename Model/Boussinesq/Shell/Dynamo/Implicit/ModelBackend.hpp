...
#ifndef QUICC_MODEL_BOUSSINESQ_SHELL_DYNAMO_IMPLICIT_MODELBACKEND_HPP
#define QUICC_MODEL_BOUSSINESQ_SHELL_DYNAMO_IMPLICIT_MODELBACKEND_HPP
...
namespace Implicit {
   ...
   class ModelBackend: public IDynamoBackend
   {
      ...
      private:
          ...
          * @param dropRows?  Drop Tau line rows
          */
         internal::SystemInfo systemInfo(const SpectralFieldId& rowId, const SpectralFieldId& colId, const int m, const Resolution& res, const BcMap& bcs, const bool isGalerkin, const bool dropRows) const;
...
#endif // QUICC_MODEL_BOUSSINESQ_SHELL_DYNAMO_IMPLICIT_MODELBACKEND_HPP
