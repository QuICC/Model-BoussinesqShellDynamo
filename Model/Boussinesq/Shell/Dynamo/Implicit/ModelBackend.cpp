   ...
   const SpectralFieldId& fId) const
{
   ...
   SpectralFieldId magTor = std::make_pair(PhysicalNames::Magnetic::id(),
      FieldComponents::Spectral::TOR);
   SpectralFieldId magPol = std::make_pair(PhysicalNames::Magnetic::id(),
      FieldComponents::Spectral::POL);
      ...
      if (rowId == colId)
      {
                          ...
                          const NonDimensional::NdMap& nds)
         {
            ...
            if (l > 0)
            {
               ...
               bMat = o.m * Pm * T * invlapl * i2r2.mat();
            }
                           ...
                           FieldComponents::Spectral::POL))
      {
                               ...
                               const NonDimensional::NdMap& nds)
         {
            ...
            if (l > 0)
            {
               ...
               bMat =
                  -static_cast<MHDFloat>(norm * Pm * T * invlapl) * cor_r.mat();

               SparseSM::Chebyshev::LinearMap::I2Y2D1 cordr(nNr, nNc, ri, ro);
               norm = -coriolis(l, o.m);
               bMat +=
                  -static_cast<MHDFloat>(norm * Pm * T * invlapl) * cordr.mat();
            }
            ...
            if (l > 0)
            {
               ...
               // Correction is not yet tested
                       ...
                       if (o.bcId == Bc::Name::NoSlip::id())
                       {
                           ...
                           bMat = static_cast<MHDFloat>(o.m * Pm * T * invlapl) *
