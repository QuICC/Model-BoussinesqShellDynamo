 ...
 * @brief Source of the Boussinesq thermal convection dynamo in a spherical
...
void IDynamoModel::addStates(SharedStateGenerator spGen)
{
   ...
   case 3: {
      ...
      auto spKernel =
         std::make_shared<Physical::Kernel::Shell::BenchmarkTempC1>();
      spKernel->init(ri, ro);
   ...
   case 3: {
      ...
      auto ro = spScalar->eqParams().nd(NonDimensional::Upper1d::id());
      auto spKernel =
         std::make_shared<Physical::Kernel::Shell::BenchmarkMagC1>();
      spKernel->init(ri, ro);
